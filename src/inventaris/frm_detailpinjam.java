...
public class frm_detailpinjam extends javax.swing.JDialog {

    public frm_detailpinjam(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tabel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_detailpinjam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_detailpinjam dialog = new frm_detailpinjam(new javax.swing.JFrame(), true);

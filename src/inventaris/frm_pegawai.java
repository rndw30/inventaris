...
public class frm_pegawai extends javax.swing.JDialog {

   
    public frm_pegawai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tabel();
        hapus();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            con.createStatement().executeUpdate("insert into pegawai values(null,'"+nama+"','"+nip+"','"+alamat+"')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            con.createStatement().executeUpdate("delete from pegawai where id_pegawai ='"+model.getValueAt(jTable1.getSelectedRow(),0)+"'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            con = koneksi.getConnection();
            con.createStatement().executeUpdate("update pegawai set nama_pegawai='"+nama+"' , nip='"+nip+"', alamat='"+alamat+"' where id_pegawai='"+model.getValueAt(jTable1.getSelectedRow(),0)+"'");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_pegawai dialog = new frm_pegawai(new javax.swing.JFrame(), true);

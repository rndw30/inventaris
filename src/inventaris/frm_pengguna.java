 ...
 * @author Cecepy
 */
public class frm_pengguna extends javax.swing.JDialog {

    
    public frm_pengguna(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tabel();
        hapus();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         try {
            ...
            con.createStatement().executeUpdate("delete from petugas where id_petugas ='"+model.getValueAt(jTable1.getSelectedRow(),0)+"'");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       jTextField3.setText(model.getValueAt(i, 3).toString()); 
        ...
        String rowadmin = model.getValueAt(i, 4).toString();
       
       if (rowadmin.equals("1")) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
        con = koneksi.getConnection();
        con.createStatement().executeUpdate("update petugas set username='"+user+"', password='"+pw+"',nama_petugas='"+nama+"' where id_petugas='"+model.getValueAt(jTable1.getSelectedRow(),0)+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_pengguna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_pengguna dialog = new frm_pengguna(new javax.swing.JFrame(), true);
    ...
    private void tabel() {
       String[] judul = {"ID","Username","Password","Nama Petugas","Level"};
       ...
       String sql = "select * from petugas ";
        try {
            ...
            while(rs.next()) {
                ...
                String[] data = {id,username,pw,nama,level};
                model.addRow(data);
            }
